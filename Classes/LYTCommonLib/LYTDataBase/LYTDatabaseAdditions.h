...
/** Category of additions for `<LYTDatabase>` class.
...
@interface LYTDatabase (LYTDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `LYTResultSet` of schema; `nil` on error.
 
 @see [SQLite File Format](http://www.sqlite.org/fileformat.html)
 */

- (LYTResultSet *)getSchema;
...
- (LYTResultSet*)getTableSchema:(NSString*)tableName;
